...
class Drone2dEnv(gym.Env):
    def __init__(self, render_sim=False, render_path=True, render_shade=False, shade_distance=70,
        ...
        self.x_target = random.uniform(250, 650)
        self.y_target = random.uniform(250, 650)
    ...
    def init_pymunk(self):
        ...
        random_x = random.uniform(350, 550)
        random_y = random.uniform(350, 550)
    ...
    def render(self, mode='human', close=False):
        ...
        pygame.draw.rect(self.screen, (128, 128, 128), pygame.Rect(0, 0, 800, 800), 8)
