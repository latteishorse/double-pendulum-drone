...
class DoubleCartpoleEnv(gym.Env):
    ...
    def init_pymunk(self):
        ...
        initial_x = random.uniform(350, 450)
        initial_y = 400
        self.target = 400
        ...
        self.cart_mass = 1
        self.cart = Cart(initial_x, initial_y, 80, 40, self.cart_mass, (255, 158, 0), self.space)

        #pole 1
        self.pole_1_mass = 1
        self.pole_1_length = 100
        pole_1_thickness = 15
        ...
        #pole 2
        self.pole_2_mass = 1
        self.pole_2_length = 70
        pole_2_thickness = 15
        beta = random.uniform(17*np.pi/36, 19*np.pi/36)
    ...
    def render(self, mode='human', close=False):
        ...
        pygame.draw.line(self.screen, (255, 158, 0), (400, 0), (400, 800), 1)
